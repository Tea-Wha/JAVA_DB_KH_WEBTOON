    ...
    public static void free_Reply_Member_Start(){
        ...
        switch (choice){
            ...
            case 2:
                ...
                break;
            case 3:
                isSuccess = pdao.post_Delete_Auto_All(free_Post_Number, user_Number);
                if (isSuccess) {
                    redao.post_Reply_Evaluation_Delete_Auto(free_Post_Number);
                    rdao.post_Reply_Delete_Auto(free_Post_Number);
                    pdao.post_Delete_Auto(free_Post_Number);
